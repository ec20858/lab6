...
app = Flask(__name__)
crime_url_template = 'https://data.police.uk/api/crimes-street/all-crime?lat={lat}&lng$
...
def crimechart():
    ...
    crime_url = crime_url_template.format(lat = my_latitude, lng = my_longitude, data $
